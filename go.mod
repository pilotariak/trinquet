module github.com/pilotariak/trinquet
...
require (
	...
	github.com/aliyun/alibaba-cloud-sdk-go v0.0.0-20190111032055-98bc04b89c27 // indirect
	...
	github.com/pilotariak/paleta v0.5.0
